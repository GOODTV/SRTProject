...
namespace Core.DataAccess
{
    public class SrtmcsCueDao
    {
        ...
        /// </history>
        public String GetCueoList(string startDate, string endDate, string channel, string _TM001, string episodeNumber, string houseNo, string premier)
        {
            ...
            strSQL.Append(" ON CUE.[HouseNo] =  EPG.[HouseNo] AND CUE.[Date] = EPG.[CalendarDate] ");
            strSQL.Append("    AND CUE.[Channel] = EPG.[Channel] AND Substring(CUE.[Time],1,2) = Substring(EPG.[Time],1,2) ");
