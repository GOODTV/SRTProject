...
namespace Core.Service
{
    public class SrtmcsCueService
    {
        ...
        /// </history>
        public DataTable GetCueList(string startDate, string endDate, string channel, string presentationTitle, string episodeNumber, string houseNo, string premier, string planningName, string calendarTime, string calendarTime2)
        {
            ...
            return dbProvider.OpenDataTable(objCueDao.GetCueoList(startDate, endDate, channel, presentationTitle, episodeNumber, houseNo, premier, planningName, calendarTime, calendarTime2), cmd);
        }
        ...
        public DataTable GetCueList(string startDate, string endDate, string channel, string presentationTitle, string episodeNumber, string houseNo, string premier)
        {
            ...
            return dbProvider.OpenDataTable(objCueDao.GetCueoList(startDate, endDate, channel, presentationTitle, episodeNumber, houseNo, premier, null, null, null), cmd);
        }
