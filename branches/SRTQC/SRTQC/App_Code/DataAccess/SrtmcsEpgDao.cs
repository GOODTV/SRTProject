...
namespace Core.DataAccess
{
    public class SrtmcsEpgDao
    {
        ...
        /// </history>
        public String GetEpgoList(string startDate, string endDate, string channel, string planningTitle, string episodeNumber, string houseNo, string premier, string planningName, string calendarTime, string calendarTime2)
        {
            ...
            if (!string.IsNullOrEmpty(calendarTime) && calendarTime != "")
                strSQL.Append(" AND SUBSTRING(EPG.[CalendarTime],1,5) >= @CalendarTime ");
            //結束時間
            if (!string.IsNullOrEmpty(calendarTime2) && calendarTime2 != "")
                strSQL.Append(" AND SUBSTRING(EPG.[CalendarTime],1,5) <= @CalendarTime2 ");
        ...
        public String GetEpgProgramName()
        {
            ...
            strSQL.Append(" SELECT [dbo].[getProgramName] (@ProgramID) ; ");
