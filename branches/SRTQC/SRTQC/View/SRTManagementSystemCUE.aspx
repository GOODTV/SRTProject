<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SRTManagementSystemCUE.aspx.cs" Inherits="SRTManagementSystemCUE" MasterPageFile="~/Master/MasterPage.master"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Button ID="impCUE" runat="server" Text="匯入CUE" OnClick="btnCUE_Click" CssClass="Button" style="cursor:pointer;"/>
