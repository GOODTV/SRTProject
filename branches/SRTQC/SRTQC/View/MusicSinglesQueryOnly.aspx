<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MusicSinglesQueryOnly.aspx.cs" Inherits="View_MusicSinglesQueryOnly" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#lblGridList .table_h tr td:nth-child(18)').each(function () {
                ...
                {
                    case "1":
                        Text = '<SPAN style="FONT-SIZE: 20px; COLOR: #0066ff">❶</SPAN>';
                        break;
                    case "2":
                        Text = '<SPAN style="FONT-SIZE: 20px; COLOR: #0066ff">❷</SPAN>';
                        break;
            ...
            /*
            $('#lblGridList .table_h tr td').dblclick(function () {

                var UniqueNumber = $(this).parent().children().eq(0).text();
                location.href = 'MusicSinglesQueryOnlyDetail.aspx?UniqueNumber=' + UniqueNumber;
            });
            */
