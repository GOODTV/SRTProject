...
public partial class View_ReleaseProgramLogQuery : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (strArray.Length > 1)
            {
                ...
                if (strArray[0] != "")
                {
                    tbxCustomerID_Pro.Text = strArray[0];
                }
                //programID
                if (strArray[1] != "")
                {
                ...
                if (strArray[2] != "")
                {
                    tbxEpisodeNo_StartPro.Text = strArray[2];
                }
                //EpisodeNo_EndPro
                if (strArray[3] != "")
                {
                    tbxEpisodeNo_EndPro.Text = strArray[3];
                }
                //YearS
                if (strArray[4] != "")
                {
            ...
            if (tbxCustomerID_Pro.Text.Trim() != "" && tbxProgramID.Text.Trim() != "" && tbxEpisodeNo_StartPro.Text.Trim() != "")
            {
                LoadFormData2();
            }
        }
    ...
    public void LoadFormData1()
    {
        ...
        if (tbxCustomerID_Pro.Text.Trim() != "")
        {
            strSql += " and R.customerID like N'%" + tbxCustomerID_Pro.Text.Trim() + "%'";
        }
        if (tbxProgramID.Text.Trim() != "")
        {
            strSql += " and R.programID like N'%" + tbxProgramID.Text.Trim() + "%'";
        }
        if (tbxEpisodeNo_StartPro.Text.Trim() != "")
        {
            strSql += " and episode >= " + tbxEpisodeNo_StartPro.Text.Trim() + " ";
        }
        if (tbxEpisodeNo_EndPro.Text.Trim() != "")
        {
            strSql += " and episode <= " + tbxEpisodeNo_EndPro.Text.Trim() + " ";
        }
        ...
        HFD_Key.Value = tbxCustomerID_Pro.Text + ";" + tbxProgramID.Text + ";" + tbxEpisodeNo_StartPro.Text + ";" + tbxEpisodeNo_EndPro.Text + ";" + ddlYearS.SelectedValue + ";" + ddlMonthS.SelectedValue + ";" + ddlYearE.SelectedValue + ";" + ddlMonthE.SelectedValue;
