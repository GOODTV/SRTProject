<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SRTManagementSystemEPG.aspx.cs" Inherits="SRTManagementSystemEPG" MasterPageFile="~/Master/MasterPage.master"%>
    ...
    <script type="text/javascript" src="../include/common.js"></script>
         <script type="text/javascript">
             ...
             function StartDateChange() {
                 var tbStartDate = $("#ContentPlaceHolder1_txtPremiereDate1").val().trim();
                 if (tbStartDate != "") {
             ...
             function EndDateChange() {
                 var tbEndDate = $("#ContentPlaceHolder1_txtPremiereDate2").val().trim();
                 if (tbEndDate != "") {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <p>
        <span style="font-size: 13px; color:blue;">提示：開始與結束日期格式：yyyymmdd (西元年月日，如20150520) , 播出與結束時間格式：hhmm (小時分鐘，如 0900 或 0930 或 2200 或 2230 等)</span>
    </p>
    ...
    <asp:Button ID="impEPG" runat="server" Text="匯入EPG" OnClick="btnEPG_Click" CssClass="Button"  style="cursor:pointer;"/>
