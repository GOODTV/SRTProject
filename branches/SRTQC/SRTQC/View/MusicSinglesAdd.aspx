<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MusicSinglesAdd.aspx.cs" Inherits="View_MusicSinglesAdd" %>
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="table_v"> 
            ...
            <tr>
                ...
                <td style="line-height: 30px;">
                    ...
                    <asp:TextBox runat="server" ID="txtSpeed" style="display: none;" Text="0"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <th style="text-align: right;">
                ...
                <td>
                    ...
                    <asp:TextBox runat="server" ID="txtRating" style="display: none;" Text="0"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <th style="text-align: right;">
